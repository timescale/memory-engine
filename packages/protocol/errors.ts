/**
 * Error codes and error types for the RPC protocol.
 *
 * Covers both JSON-RPC 2.0 protocol errors and application-level errors.
 */
import type { JsonRpcError, JsonRpcErrorResponse } from "./jsonrpc.ts";
