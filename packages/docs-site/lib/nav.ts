...
export const NAV: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: "Searching Memories", slug: "search" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "me status", slug: "cli/me-status" },
      { label: "me doctor", slug: "cli/me-doctor" },
      { label: "me init", slug: "cli/me-init" },
      { label: "me invite", slug: "cli/me-invite" },
      ...
      { label: "me access", slug: "cli/me-access" },
      { label: "me pack", slug: "cli/me-pack" },
      { label: "me completions", slug: "cli/me-completions" },
      { label: "me version", slug: "cli/me-version" },
      { label: "me upgrade", slug: "cli/me-upgrade" },
    ],
  },
  {
    title: "MCP Tools",
    items: [
      ...
      { label: "me_space_list", slug: "mcp/me_space_list" },
      { label: "me_memory_context", slug: "mcp/me_memory_context" },
      ...
      { label: "me_memory_history", slug: "mcp/me_memory_history" },
      { label: "me_memory_search", slug: "mcp/me_memory_search" },
      { label: "me_memory_count", slug: "mcp/me_memory_count" },
      { label: "me_memory_update", slug: "mcp/me_memory_update" },
      { label: "me_memory_revert", slug: "mcp/me_memory_revert" },
      { label: "me_memory_delete", slug: "mcp/me_memory_delete" },
      {
        label: "me_memory_delete_by_path",
        slug: "mcp/me_memory_delete_by_path",
      },
      { label: "me_memory_delete_tree", slug: "mcp/me_memory_delete_tree" },
      { label: "me_memory_tree", slug: "mcp/me_memory_tree" },
      { label: "me_memory_copy", slug: "mcp/me_memory_copy" },
